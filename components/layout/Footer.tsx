export default function Footer() {
  const campuses = [
    {
      name: 'Campus Regina',
      address: 'rua email.com',
      phone: '(47) 3345-7888',
      details: [
        'Rua da 123',
        'Bairro 123',
        'Bloco Social Fundação Educacional Univ',
        'CNPJ 123.456.789/0001-98'
      ]
    },
    {
      name: 'Campus Regina',
  ...
  return (
    <footer className="bg-green-800 text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          {campuses.map((campus, index) => (
            <div key={index}>
              ...
              <div className="space-y-2 text-sm">
                <p>{campus.address}</p>
                <p>{campus.phone}</p>
                {campus.details.map((detail, detailIndex) => (
        ...
        {/* Social Media */}
        <div className="flex justify-center space-x-6 mt-12 pt-8 border-t border-green-700">
        ...
        {/* Copyright */}
        <div className="text-center mt-8 pt-8 border-t border-green-700 text-sm">
          <p>Universidade da Região - UNIVILLE 2025</p>
        </div>
      </div>
    </footer>
  );
